...
const FileExtractor = () => {
  ...
  return (
    <div
      className="min-h-screen flex flex-col items-center p-4 sm:p-2 bg-cover bg-center"
    >
      {/* Chat History */}
      ...
      <div className="bg-white/10 backdrop-blur-lg rounded-lg shadow-xl p-6 space-y-6 w-full sm:w-[80%] md:w-[65%] mt-6">
        ...
        <div className="flex items-center justify-center">
          ...
          <button
            ...
            disabled={loading}
            className={`p-4 ml-3 rounded-lg font-semibold text-white flex justify-center items-center transition-all duration-200 shadow-md ${loading
